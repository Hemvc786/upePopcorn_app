...
Example:-
here we need the movies state i.e present in App component to MovieList.
App->Main->ListBox->MovieList

here also we need the movies state i.e in App component to NumResults.
...
export default function App() {
  ...
  return (
    <>
      {/* Entire LAYOUT using component composition */}
